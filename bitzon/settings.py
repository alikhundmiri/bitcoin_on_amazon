"""
Django settings for bitzon project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', '*r@hcx6iudh@*njtqh$y)(8_pbpr=j2r5yojw@z(^qpro00@lj')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['www.btc-amazon.herokuapp.com','btc-amazon.herokuapp.com','127.0.0.1']
...
WSGI_APPLICATION = 'bitzon.wsgi.application'
